  ...
  function (e, t, n) {
    ...
    function p(t, r) {
      ...
      if ("CSSSupportsRule" in e) {
        ...
        return i = i.join(" or "),
          u("@supports (" + i + ") { #modernizr { position: absolute; } }",
            function (e) {
    ...
    function h(e, t, o, i) {
      ...
      for (var u, d, c, h, v, A = ["modernizr", "tspan", "samp"]; !N.style && A.length;) u = !0,
        N.modElem = a(A.shift()),
        N.style = N.modElem.style;
      for (c = e.length, d = 0; c > d; d++) if (h = e[d], v = N.style[h], f(h, "-") && (h = m(h)), N.style[h] !== n) {
        if (i || r(o, "undefined")) return s(),
          "pfx" == t ? h : !0;
        try {
          N.style[h] = o
        } catch (g) { }
        if (N.style[h] != v) return s(),
          "pfx" == t ? h : !0
      }
      return s(),
        !1
    ...
    var P; !
      function () {
        ...
        P = r(e, "undefined") || r(e.call, "undefined") ?
          function (e, t) {
    ...
    var z = function () {
      ...
      return t ?
        function (e) {
          ...
          var n = !1;
          return u("@media " + t + " { #modernizr { position: absolute; } }",
            function (t) {
    ...
    Modernizr.addTest("websockets", R),
      ...
      Modernizr.addAsyncTest(function () {
        var e, t, n, r = a("img"),
          o = "sizes" in r; !o && "srcset" in r ? (t = "data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw==", e = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", n = function () {
            s("sizes", 2 == r.width)
          },
