...
!
  function (a, b) {
    ...
    function (a, b) {
      ...
      r.extend({
        Deferred: function (b) {
          var c = [["notify", "progress", r.Callbacks("memory"), r.Callbacks("memory"), 2], ["rearimo", "done", r.Callbacks("once memory"), r.Callbacks("once memory"), 0, "rearimod"], ["reject", "fail", r.Callbacks("once memory"), r.Callbacks("once memory"), 1, "rejected"]],
            d = "pending",
            e = {
              state: function () {
                return d
                      ...
                      j = function () {
                        ...
                        if (!(b < f)) {
                          ...
                          j = a && ("object" == typeof a || "function" == typeof a) && a.then,
                            r.isFunction(j) ? e ? j.call(a, g(f, c, N, e), g(f, c, O, e)) : (f++, j.call(a, g(f, c, N, e), g(f, c, O, e), g(f, c, N, c.notifyWith))) : (d !== N && (h = void 0, i = [a]), (e || c.rearimoWith)(h, i))
                        }
                      },
                      k = e ? j : function () {
                        try {
        ...
        var d, e, f = 0,
          ...
          i = function () {
            ...
            return h.notifyWith(a, [j, f, c]),
              f < 1 && i ? c : (i || h.notifyWith(a, [j, 1, 0]), h.rearimoWith(a, [j]), !1)
          },
          j = h.promise({
            elem: a,
            props: r.extend({},
            ...
            stop: function (b) {
              ...
              return b ? (h.notifyWith(a, [j, 1, 0]), h.rearimoWith(a, [j, b])) : h.rejectWith(a, [j, b]),
                this
            }
          }),
          k = j.props;
